...
namespace Tbasic.Libraries
{
    ...
    public class AutoLibrary : Library
    {
        ...
        private object MouseClick(Executor runtime, StackFrame stackdat)
        {
        ...
        private object MouseMove(Executor runtime, StackFrame stackdat)
        {
        ...
        private object BlockInput(Executor runtime, StackFrame stackdat)
        {
        ...
        private object Send(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
        ...
        private object VolumeUp(Executor runtime, StackFrame stackdat)
        {
        ...
        private object VolumeDown(Executor runtime, StackFrame stackdat)
        {
            if (stackdat.ParameterCount == 1) {
                stackdat.Add(1);
            }
        ...
        private object VolumeMute(Executor runtime, StackFrame stackdat)
        {
