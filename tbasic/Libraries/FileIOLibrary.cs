...
namespace Tbasic.Libraries
{
    ...
    public class FileIOLibrary : Library
    {
        ...
        private static object DirExists(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
            return Directory.Exists(stackdat.Get<string>(1));
        }

        private static object FileExists(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
            return File.Exists(stackdat.Get<string>(1));
        }

        private static object FileMove(Executor runtime, StackFrame stackdat)
        {
        ...
        private static object FileCopy(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(3);
        ...
        private static object FileDelete(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
        ...
        private static object DirDelete(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
        ...
        private static object DirMove(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(3);
        ...
        private static object DirCreate(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
        ...
        private static object DirGetFileList(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
            return Directory.GetFiles(stackdat.Get<string>(1));
        }

        private static object DirGetDirList(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
            return Directory.GetDirectories(stackdat.Get<string>(1));
        }

        private static object FileReadAll(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
            return File.ReadAllText(stackdat.Get<string>(1));
        }

        private static object FileWriteAll(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(3);
        ...
        private static object Recycle(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
        ...
        private static object FileGetAttributes(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
            string path = stackdat.Get<string>(1);
        ...
        private static object FileSetAttributes(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(3);
            string path = stackdat.Get<string>(1);
            FileAttributes current = File.GetAttributes(path);
        ...
        private static object FileSetAccessDate(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(3);
            string path = stackdat.Get<string>(1);
            try {
        ...
        private static object FileSetModifiedDate(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(3);
            string path = stackdat.Get<string>(1);
            try {
        ...
        private static object FileSetCreatedDate(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(3);
            string path = stackdat.Get<string>(1);
            try {
        ...
        private static object Shell(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
            string output;
