...
namespace Tbasic.Libraries
{
    ...
    public class UserIOLibrary : Library
    {
        ...
        private object ConsoleWriteline(Executor runtime, StackFrame stackdat)
        {
        ...
        private object ConsoleWrite(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
        ...
        private object ConsoleRead(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(1);
            return Console.Read();
        }

        private object ConsoleReadLine(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(1);
            return Console.ReadLine();
        }

        private object ConsoleReadKey(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(1);
            return Console.ReadKey().KeyChar;
        }

        private object ConsolePause(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(1);
        ...
        private object Input(Executor runtime, StackFrame stackdat)
        {
        ...
        private object TrayTip(Executor runtime, StackFrame stackdat)
        {
            if (stackdat.ParameterCount == 2) {
                stackdat.Add(""); // title
                stackdat.Add(0); // icon
        ...
        private object MsgBox(Executor runtime, StackFrame stackdat)
        {
            if (stackdat.ParameterCount == 3) {
                stackdat.Add("");
            }
        ...
        private object Say(Executor runtime, StackFrame stackdat)
        {
            stackdat.AssertCount(2);
